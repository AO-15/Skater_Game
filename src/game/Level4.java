...
public class Level4 extends GameLevel {
        ...
        private static final Color platformColour = Color.GREEN;
    /**
     * Populate the world.
     * @param game
     */
        ...
        
{
        ...
        }
        {
            ...
            explosive.addCollisionListener(new DecrementLives(skater));
                ...
                {
            Body explosive = new Explosive(this);
            explosive.setPosition(new Vec2(50, 10.5f));
            explosive.addCollisionListener(new DecrementLives(skater));
        }
                
                        {
            Body explosive = new Explosive(this);
            explosive.setPosition(new Vec2(65, 10.5f));
            explosive.addCollisionListener(new DecrementLives(skater));
        }
